                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group1 text-left mb-2">
                        ...
                        <input type="text" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\.*)\./g, '$1');" class="form-control neha-text" id="date1" name="amount" required>
                      </div>
                    </div>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="<?php echo e(route('Update.Expense.Data',['id'=>$value->id])); ?>" enctype="multipart/form-data">
                              ...
                              <div class="mb">
                                <label for="Phone">Amount</label>
                              <input type="text" class="form-control neha-text" id="date1" name="amount" value="<?php echo e($value->amount); ?>" maxlength="10" required>
                              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/expenses/index.blade.php ENDPATH**/ ?>