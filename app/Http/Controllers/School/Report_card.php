...
class Report_card extends Controller
{
    ...
    function student_report_del($id){
        ...
        if ($del->delete()) {
            ...
            return back()->with('error','Error No Delete Data SuccessFull');
...
function Repotcard_up(Request $req,$id){
     ...
     if ($up->update()) {
        return redirect()->route('SCHOOL.Report.card')->with('success','Data Update SuccessFull');
     } else {
        return back()->with('error','Error No Data Update SuccessFull');
     }
...
function school_information_in(Request $req){
    ...
    if ($in->save()) {
        return back()->with('success','Data Send SuccessFull');
    } else {
        return back()->with('error','Error Data Not Send SuccessFull');
    }
