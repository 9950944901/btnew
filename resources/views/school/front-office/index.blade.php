                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <div class="form-group1 text-left">
                            ...
                            <input type="text" minlength="10" maxlength="10" class="form-control" value="{{old('phone')}}" name="phone"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                          <div class="form-group1 text-left">
                            ...
                            <input type="text" pattern="['0-9']*" class="form-control" value="{{old('number_of_child')}}" name="number_of_child">
                          </div>
                        </div>
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="number">Number of Child</label>
                              <input type="text" pattern="['0-9']*" class="form-control" name="number_of_child" value="{{ $value->number_of_child }}">
                            </div>
                          </div>
                          <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
