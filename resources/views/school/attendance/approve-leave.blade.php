          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
              ...
              <div class="d-flex justify-content-between mb-3">
                <h5 class="" style="font-size: 17px;">Student Approve Leave List</h5>
                  ...
                  <tr id="task-2" class="task-list-row test-font" data-task-id="2" data-user="Silver">
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        @endif
                        @if($value->document)
                        <a href="{{ url('public/uploads/studentleave/'.$value->document) }}" class="btn btn-light ml-1" download><i class="fa fa-download"></i></a>
                        @else
