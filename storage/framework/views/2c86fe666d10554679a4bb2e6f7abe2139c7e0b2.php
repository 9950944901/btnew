                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <div class="form-group1 text-left">
                            ...
                            <input type="text" minlength="10" maxlength="10" class="form-control" value="<?php echo e(old('phone')); ?>" name="phone"
                              placeholder="Enter Phone no." pattern="[0-9]*">
                          </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <div class="form-group1 text-left">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                          <div class="form-group1 text-left">
                            ...
                            <input type="text" pattern="['0-9']*" class="form-control" value="<?php echo e(old('number_of_child')); ?>" name="number_of_child">
                          </div>
                        </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                  ...
                  <td>
                    <div class="d-flex">
                      <a href="tel:<?php echo e($value->phone); ?>" class="btn btn-light ml-1"><i
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="Phone">Phone</label>
                              <input type="text" class="form-control" name="phone" value="<?php echo e($value->phone); ?>"
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="Phone">Description</label>
                              <textarea name="desc" class="form-control" rows="2"
                                placeholder="Enter here..."><?php echo e($value->desc); ?></textarea>
                            </div>
                          </div>
                          ...
                          <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              ...
                              <select name="source" class="form-control">
                                <?php if($value->source): ?>
                                <option><?php echo e($value->source); ?></option>
                                <?php else: ?>
                                <option value="">Select</option>
                                <?php endif; ?>
                                <option>Self</option>
                          ...
                          <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="number">Number of Child</label>
                              <input type="text" pattern="['0-9']*" class="form-control" name="number_of_child" value="<?php echo e($value->number_of_child); ?>">
                            </div>
                          </div>
                          <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/front-office/index.blade.php ENDPATH**/ ?>