...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('SuperAdmin.Home') }}" class="logo d-flex align-items-center">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"  href="{{ route('SuperAdmin.Users') }}">
          <i class="bi bi-menu-button-wide"></i><span>All Users</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed"  href="{{ route('SuperAdmin.Addnew') }}">
          <i class="bi bi-menu-button-wide"></i><span>Add New</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed"  href="{{ route('SuperAdmin.contact') }}">
          <i class="bi bi-menu-button-wide"></i><span>Contact Request</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('SuperAdmin.Logout') }}">
