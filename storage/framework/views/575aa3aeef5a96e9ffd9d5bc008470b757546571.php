                          ...
                          <div class="modal-body">
                            <form method="post" action="<?php echo e(route('SCHOOL.EDIT.Class',['id'=>$value->id])); ?>">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\.*)\./g, '$1');" name="class" value="<?php echo e($value->class); ?>" id="recipient-name" required>
                              </div>
                            ...
                            <form method="post" action="<?php echo e(route('SCHOOL.Edit.Section',['id'=>$value->id])); ?>">
                              ...
                              <div class="mb-3">
                                ...
                                <select name="class" required class="form-control">
                                  ...
                                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <form method="post" action="<?php echo e(route('SCHOOL.ADD.Section')); ?>">
              ...
              <div class="mb-3">
                ...
                <select name="class" required class="form-control">
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clzz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option><?php echo e($clzz->class); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
              <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/student-information/online-admission.blade.php ENDPATH**/ ?>