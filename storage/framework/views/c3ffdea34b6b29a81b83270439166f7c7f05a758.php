                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group1 mb-2">
                        ...
                        <input type="text" class="form-control neha-text" maxlength="30" required name="purpose">
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group1 text-left mb-2">
                        ...
                        <input type="text" required pattern="[0-9]*" class="form-control neha-text" name="phone" maxlength="10" minlength="10" pattern="['0-9']*">
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/front-office/visitor-Book.blade.php ENDPATH**/ ?>