        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <img src="{{ url('storage/app/public/'.$user->image) }}" style="height: 120px;width:100%;" alt="NO IMAGE" class="rounded-circle">
                @else
                <img src="{{ url('public/avtar.png') }}" style="height: 120px;width:100%;" alt="NO IMAGE" class="rounded-circle">
              @endif
              <h2>{{ $user->name ?? 'Admin' }}</h2>
              <h3>{{ $user->job ?? 'Admin' }}</h3>
            </div>
          </div>
              ...
              <div class="tab-content pt-2" id="nav-tabContent">
                <div class="tab-pane fade show active" id="profile_overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $user->rand_id ?? '' }}</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Full Name</div>
                    <div class="col-lg-9 col-md-8">{{ $user->name ?? 'Admin' }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">School</div>
                    <div class="col-lg-9 col-md-8">{{ $user->school_name ?? 'Test School' }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Job</div>
                    <div class="col-lg-9 col-md-8">{{ $user->job ?? 'Admin' }}</div>
                  </div>
                  ...
                  <form method="post" action="{{ route('ADMIN.Profile.Update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        @if(!is_null($user->image))
                        <img src="{{ url('storage/app/public/'.$user->image) }}" style="height: 115px;width: 200px;" alt="NO IMAGE">
                        @else
                        <img src="{{ url('public/avtar.png') }}" alt="NO IMAGE">
                        @endif
                        <div class="pt-2">
