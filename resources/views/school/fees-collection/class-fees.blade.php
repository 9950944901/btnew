                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group1 text-left mb-2">
                        ...
                        <input type="text" class="form-control neha-text" readonly name="session" value="{{ $info->session ?? '' }}" >
                        @error('session')
                          ...
                          <div class="modal-body">
                            <form method="post" action="{{ route('Fees.edit.discount',['id'=>$value->id]) }}">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="amount" value="{{ $value->amount }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\.*)\./g, '$1');" minlength="3" maxlength="10" required>
                              </div>
