                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group1 text-left mb-2">
                        ...
                        <input type="text" class="form-control neha-text" id="date1" name="name" required maxlength="30">
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/fees-collection/fees-type.blade.php ENDPATH**/ ?>