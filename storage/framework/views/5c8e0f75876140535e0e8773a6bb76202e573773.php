          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body" style="padding: 0 20px 0px 20px;">
                <h5 class="card-title" style="padding: 15px 0 0px 0; float: inherit;">Add Class Fees</h5>
                <hr>
                <div class="activity">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group1 text-left mb-2">
                        ...
                        <input type="text" class="form-control neha-text" readonly name="session" value="<?php echo e($info->session ?? ''); ?>" >
...
unset($__errorArgs, $__bag); ?></label>
                        <select name="discount" class="form-control neha-text" required>
                          ...
                          <?php $__currentLoopData = $class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $clz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Class Fees</h5>
                          ...
                          <div class="modal-body">
                            <form method="post" action="<?php echo e(route('Fees.edit.discount',['id'=>$value->id])); ?>">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="amount" value="<?php echo e($value->amount); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\.*)\./g, '$1');" minlength="3" maxlength="10" required>
                              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/fees-collection/class-fees.blade.php ENDPATH**/ ?>