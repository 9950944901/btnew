              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr id="task-1" class="task-list-row test-font " data-task-id="1" data-user="Platinum">
                    ...
                    <td>
                      <div class="d-flex">
                        <a style="border:none;" href="<?php echo e(route('SCHOOL.staff-directory-show',['id'=>$value->id])); ?>" class="btn btn-light ml-1"><i class="fa fa-bars"></i></a>
                        <a style="border:none;" href="<?php echo e(route('SCHOOL.staff-directory-edit-staff',['id'=>$value->id])); ?>" class="btn btn-light  ml-1"><i class="fa fa-pencil"></i></a>

                        <a style="border:none;" href="<?php echo e(route('SCHOOL.staff-directory-del',['id'=>$value->id])); ?>" class="btn btn-light  delete-confirm text-danger  ml-1"><i class="fa fa-trash "></i></a>
                      </div>
                    </td>
                  </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/human-resource/index.blade.php ENDPATH**/ ?>