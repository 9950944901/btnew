...
<body id="scroll-top" class="home-3">
  ...
  <div class="mobile-menu-area">
    <div class="logo-area">
      <a class="logo" href="<?php echo e(route('Site.Home')); ?>"><img src="<?php echo e(url('public/uploads/site-logo/'.$data->web_logo)); ?>" alt="logo" class="img-responsive"></a>
      ...
      <div class="container">
        <div class="row no-gutters">
          <nav class="main-menu-area w-100">
            <div class="logo-area">
              <a class="" href="<?php echo e(route('Site.Home')); ?>"><img src="<?php echo e(url('public/uploads/site-logo/'.$data->web_logo)); ?>" alt="logo" class="img-responsive"></a>
              <button type="button" class="navbar-toggle collapsed d-md-none" data-toggle="collapse"
                data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                <span class="sr-only">Toggle navigation</span>
                <span class="icon-bar"></span>
  ...
  <!-- header End here --><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/site/layouts/header.blade.php ENDPATH**/ ?>