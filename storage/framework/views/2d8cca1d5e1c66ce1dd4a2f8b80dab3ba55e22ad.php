                ...
                <div class="row mb-2">
                  <div class="col-lg-2 col-md-6 col-sm-12">
                    <div>
                      ...
                      <img src="<?php echo e(url('storage/app/public/'.$show->student_image)); ?>" width="100" height="100">
                      <?php else: ?>
                      <img src="<?php echo e(url('public/av.png')); ?>" width="100">
                      <?php endif; ?>
                    </div>
                  </div>
                  <div class="col-lg-5 col-md-6 col-sm-12">
                    <div class="ml-1 mr-2">
                      ...
                      <div class="d-flex justify-content-between">
                        ...
                        <p class="mb-1"><?php echo e($show->mobile_no); ?></p>
                      </div>
                  ...
                  <div class="col-lg-5 col-md-6 col-sm-12">
                    <div class="ml-1 mr-2">
                      ...
                      <div class="d-flex justify-content-between">
                        ...
                        <p class="mb-1"><?php echo e($total_fee->amount ?? ''); ?></p>
                      </div>
                    </div>
                  </div>
                  <hr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/btschool.in/public_html/resources/views/school/fees-collection/collect-fees-action.blade.php ENDPATH**/ ?>